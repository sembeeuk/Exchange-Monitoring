...
schtasks /create /tn "Exchange Health Dashboard" /tr "powershell.exe -ExecutionPolicy Bypass -File C:\Scripts\exchangehealth-dashboard.ps1" /sc minute /mo 5 /ru SYSTEM /rl HIGHEST /f
